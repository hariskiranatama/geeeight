...
class RecaptchaComponent extends Object {
    var $publickey = "6LfzcL4SAAAAAEviX8-nbok4nsy0EuzaU3byUaLk";
    var $privatekey= "6LfzcL4SAAAAACJVE4CM5k7WevxzBM3K92BjNoDj";
    ...
    function valid($form) {
        if ( isset($form['recaptcha_challenge_field']) && isset($form['recaptcha_response_field']) ) {
            if ( $this->recaptcha_check_answer( $this->privatekey,
                                               $_SERVER["REMOTE_ADDR"],
                                               $form['recaptcha_challenge_field'],
                                               $form['recaptcha_response_field'] ) == 0 )
            return false;
    ...
    function recaptcha_check_answer ($privkey, $remoteip, $challenge, $response, $extra_params = array()){
        ...
        Configure::write("Recaptcha.verifyServer","api-verify.recaptcha.net");
        $response = $this->_recaptcha_http_post(Configure::read('Recaptcha.verifyServer'), "/verify", array (
            'privatekey' => $privkey, 
            'remoteip' => $remoteip, 
            'challenge' => $challenge, 
            'response' => $response 
