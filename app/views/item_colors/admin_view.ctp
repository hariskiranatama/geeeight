<div class="itemColors view">
<h2><?php  __d("admin", 'Item Color');?></h2>
    <dl><?php $i = 0; $class = ' class="altrow"';?>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Color Id'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemColor['ItemColor']['color_id']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Color Name'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemColor['ItemColor']['color_name']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Hexa Decimal'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemColor['ItemColor']['hexa_decimal']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Active'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemColor['ItemColor']['active']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Created'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemColor['ItemColor']['created']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Modified'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemColor['ItemColor']['modified']; ?>
            &nbsp;
        </dd>
    </dl>
</div>
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__d("admin", 'Edit Item Color', true), array('action' => 'edit', $itemColor['ItemColor']['color_id'])); ?> </li>
        <li><?php echo $this->Html->link(__d("admin", 'Delete Item Color', true), array('action' => 'delete', $itemColor['ItemColor']['color_id']), null, sprintf(__d("admin", 'Are you sure you want to delete # %s?', true), $itemColor['ItemColor']['color_id'])); ?> </li>
