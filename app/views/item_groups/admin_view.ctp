...
<h2><?php  __d("admin", 'Item Group');?></h2>
    <dl><?php $i = 0; $class = ' class="altrow"';?>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Group Id'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemGroup['ItemGroup']['group_id']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Group Name'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemGroup['ItemGroup']['group_name']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Active'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemGroup['ItemGroup']['active']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Created'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemGroup['ItemGroup']['created']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Modified'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemGroup['ItemGroup']['modified']; ?>
            &nbsp;
        </dd>
    </dl>
</div>
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__d("admin", 'Edit Item Group', true), array('action' => 'edit', $itemGroup['ItemGroup']['group_id'])); ?> </li>
        <li><?php echo $this->Html->link(__d("admin", 'Delete Item Group', true), array('action' => 'delete', $itemGroup['ItemGroup']['group_id']), null, sprintf(__d("admin", 'Are you sure you want to delete # %s?', true), $itemGroup['ItemGroup']['group_id'])); ?> </li>
