<div class="itemSizes view">
<h2><?php  __d("admin", 'Item Size');?></h2>
    <dl><?php $i = 0; $class = ' class="altrow"';?>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Size Id'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemSize['ItemSize']['size_id']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Size'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemSize['ItemSize']['size']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Active'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemSize['ItemSize']['active']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Created'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemSize['ItemSize']['created']; ?>
            &nbsp;
        </dd>
        <dt<?php if ($i % 2 == 0) echo $class;?>><?php __d("admin", 'Modified'); ?></dt>
        <dd<?php if ($i++ % 2 == 0) echo $class;?>>
            <?php echo $itemSize['ItemSize']['modified']; ?>
            &nbsp;
        </dd>
    </dl>
</div>
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__d("admin", 'Edit Item Size', true), array('action' => 'edit', $itemSize['ItemSize']['size_id'])); ?> </li>
        <li><?php echo $this->Html->link(__d("admin", 'Delete Item Size', true), array('action' => 'delete', $itemSize['ItemSize']['size_id']), null, sprintf(__d("admin", 'Are you sure you want to delete # %s?', true), $itemSize['ItemSize']['size_id'])); ?> </li>
