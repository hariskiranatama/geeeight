<div class="banner mix">
    ...
    <?php else: ?>
        <img class="ban" src="<?php echo $this->webroot; ?>images/banner-mix-bg.jpg" alt="background"/>
    <?php endif; ?>
    <div class="ver">
    ...
    <div class="hz">
        <?php if ( isset($thumbnails) AND $thumbnails['landscape']['images'] ): ?>
            <?php foreach ( $thumbnails['landscape']['images'] as $index => $thumbnail ): ?>
                <?php $url = $thumbnail['WebsiteImage']['link_url'] ? $thumbnail['WebsiteImage']['link_url'] : '#'; ?>
                <div class="landscape<?php if ( $index == 0 ): ?> first<?php endif; ?>">
                    <img class="new<?php if ( $thumbnail['WebsiteImage']['is_new'] != 1 ): ?> disabled<?php endif; ?>" src="<?php echo $this->webroot; ?>images/new.png" alt="new"/>
                    <div class="image">
                        <a href="<?php echo $url; ?>">
                            <?php echo $this->MeioUpload->displayFile('image_file', array(
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <div class="landscape first">
                <img class="new" src="<?php echo $this->webroot; ?>images/new.png" alt="new"/>
                <div class="image">
                    <a href="#">
                        <img src="<?php echo $this->webroot; ?>images/dressesm.jpg" alt="dress"/>
                    </a>
                </div>
                <div class="text">
            ...
            <div class="landscape">
                ...
                <div class="image">
                    <a href="#">
                        <img src="<?php echo $this->webroot; ?>images/topsm.jpg" alt="dress"/>
                    </a>
                </div>
                <div class="text">
                    <h3><a href="#">Tops</a></h3>
            ...
            <div class="landscape">
                ...
                <div class="image">
                    <a href="#">
                        <img src="<?php echo $this->webroot; ?>images/jacketsm.jpg" alt="dress"/>
                    </a>
                </div>
                <div class="text">
            ...
            <div class="landscape">
                ...
                <div class="image">
                    <a href="#">
                        <img src="<?php echo $this->webroot; ?>images/bottomsm.jpg" alt="dress"/>
                    </a>
                </div>
                <div class="text">
