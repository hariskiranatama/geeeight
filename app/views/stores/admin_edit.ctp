<div class="stores form">
    ...
    <fieldset>
        <legend><?php __d("admin", 'Edit Store'); ?></legend>
        ...
        <?php echo $this->MeioUpload->displayFile('store_image', array('label' => 'Existing Image')); ?>
...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__d("admin", 'Delete', true), array('action' => 'delete', $this->Form->value('Store.id')), null, sprintf(__d("admin", 'Are you sure you want to delete this store?', true), $this->Form->value('Store.id'))); ?></li>
